...
var HomePage = /** @class */ (function (_super) {
    ...
    function HomePage() {
        ...
        //contacts tab
        _this.contacts = _this.ElementLocator(Locators.contacts);
        return _this;
    }
    //open browser
    ...
    HomePage.prototype.GetHeading = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.contacts.getText().then(function (text) {
    ...
    HomePage.prototype.ClickTab = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.contacts.click()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
